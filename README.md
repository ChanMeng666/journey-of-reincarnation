...
<a href="https://journey-of-reincarnation.pages.dev/">
  <img src="docs/showcase/hero.webp" alt="Journey of Reincarnation landing page — dark space-themed UI with constellation animations, the circular logo, and a glowing pink-purple Start Journey button" width="100%">
</a>

![Demo: clicking Start Journey to generate a new life, revealing character stats, rarity rating, talents, lifespan, Soul Profile karma tracker, and an interactive world map](docs/showcase/demo.gif)

<details>
<summary>📱 More screenshots</summary>

| Reincarnation Result | Mobile View |
|---|---|
| <img src="docs/showcase/result.webp" width="520"> | <img src="docs/showcase/mobile-hero.webp" width="260"> |
